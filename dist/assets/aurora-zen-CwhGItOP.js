const o={name:"aurora-zen",description:"Gentle flowing aurora borealis for zen racing",author:"Velocity Sphere Team",version:"1.0.0",tags:["aurora","zen","peaceful","circuit-tranquil"],performance:"good",uniforms:{auroraColor1:{value:[.1,.8,.6]},auroraColor2:{value:[.3,.5,.9]},auroraColor3:{value:[.6,.3,.8]},baseColor:{value:[.05,.05,.1]},flowSpeed:{value:.2},waveScale:{value:.03},intensity:{value:.7}},vertexShader:`
  ...
  `};export{o as default};
//# sourceMappingURL=aurora-zen-CwhGItOP.js.map
