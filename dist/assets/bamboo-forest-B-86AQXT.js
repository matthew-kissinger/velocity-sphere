const o={name:"bamboo-forest",description:"Dappled sunlight through bamboo creating natural patterns",author:"Velocity Sphere Team",version:"1.0.0",tags:["bamboo","forest","natural","circuit-tranquil"],performance:"good",uniforms:{groundColor:{value:[.25,.3,.15]},sunlitColor:{value:[.45,.5,.3]},shadowColor:{value:[.15,.2,.1]},dappleScale:{value:.08},windSpeed:{value:.2},shadowSoftness:{value:.3}},vertexShader:`
  ...
  `};export{o as default};
//# sourceMappingURL=bamboo-forest-B-86AQXT.js.map
