import{a as o}from"./main-BYuQSTlm.js";const e={name:"laser-grid",description:"Bright laser grid with high-tech appearance",author:"Circuit Epsilon AI Agent",version:"1.0.0",tags:["laser","grid","bright","technical","underground"],performance:"excellent",uniforms:{laserColor1:{value:new o(65535)},laserColor2:{value:new o(16776960)},backgroundColor:{value:new o(1297)},gridSize:{value:15},laserWidth:{value:.05},pulseSpeed:{value:3},brightness:{value:2}},vertexShader:`
  ...
  `};export{e as default};
//# sourceMappingURL=laser-grid-CeMdEgCh.js.map
