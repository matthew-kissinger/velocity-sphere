const o={name:"neon-tubes",uniforms:{tubeColor1:{value:[.1,.4,.8]},tubeColor2:{value:[.8,.1,.4]},glowColor:{value:[.2,.6,1]},baseColor:{value:[.02,.02,.05]},ringSpacing:{value:8},glowIntensity:{value:.6},pulseSpeed:{value:1.5}},vertexShader:`
  ...
  `};export{o as default};
//# sourceMappingURL=neon-tubes-qvY-qdT6.js.map
